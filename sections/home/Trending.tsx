...
function Trending() {
  const q = query(collection(firestore, "articles"), limit(3), orderBy("created_at"));
      ...
      <div className={styles.content}>
        <div className={styles.left_column}>
          <Cover
            ...
            time={time(arr1)} like={200} view={200} />
        </div>
        <div className={styles.rigth_column}>
          <Cover
            ...
            time={time(arr2)} like={200} view={200} />
          <Cover
            trending
            image={arr3?.images[0]}
            category='SPORT'
            ...
            title='Creative photography ideas from smart devices'
            authorname="Nahyu Nanda"
            time={time(arr3)} like={200} view={200} />
        </div>
      </div>
    </SectionContainer>
  );
